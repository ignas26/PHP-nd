...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2018 at 03:27 PM
...
(3, '2018_03_11_120909_create_pages_table', 1),
(4, '2018_03_11_121018_create_categories_table', 1);
...
INSERT INTO `posts` (`id`, `content`, `category_id`, `author`) VALUES
...
--
-- Table structure for table `postsp19`
--

CREATE TABLE `postsp19` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `postsp19`
--
ALTER TABLE `postsp19`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `postsp19`
--
ALTER TABLE `postsp19`
